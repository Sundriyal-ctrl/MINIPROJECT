...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js" integrity="sha512-VEd+nq25CkR676O+pLBnDW09R7VQX9Mdiij052gVCp5yVH3jGtH70Ho/UUv4mJDsEdTvqRCFZg0NKGiojGnUCw==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <body>
        <br>
        <div class="container  shadow col-sm-5" style="padding:40px;">
            <br>
            <div id="danger"></div>
            
            <div>
                <br>
                <form action="RegistrationGet.jsp" method="post">
                ...
                <br>
                <input type="password" placeholder="Create Password" name="Password" class="form-control" id="Password" required="">
              ...
              <br>
                ...
                <br>
                <input type="text" class="form-control" placeholder="Adhar DOB" onfocus="(this.type='date')" id="DOB"/>
                <strong><span id="dob" style="color:red;font-size:13px"></span></strong>
               
                <br>
                
          
                 <div class="d-grid gap-2" >
                    <input type="Submit" value="Registered" class="btn btn-warning" id="regsub" style="color:white;font-weight:600;">
                </div>
                
                
               
                </form>
                <strong>if already have account ?<a href="Login.jsp">Login</a></strong>
                <details>
...
$('#Adhar').keyup(function(){
 ...
 $('#VehicleNo').keyup(function(){
    ...
    {
       document.getElementById("veh").innerHTML="***Empty Filed not Allowed";
       ve=0;
        return false;
        }
    else
 ...
 return false;
    ...
    <script>
	  ...
	  req.open("POST","emaillcheck.jsp?Email="+a+"",true);
	  ...
	  req.onreadystatechange =()=>{
	    ...
	    else if(req.status===201)
	    {
	       ...
	       document.getElementById("email").innerHTML="This Gmail is already registered";
               em=0;
                return false;
	    }
          return false;
